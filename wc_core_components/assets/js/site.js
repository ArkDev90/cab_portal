...
$('body').on('keydown', '[data-validation*="decimal"]', function(e) {
	...
	var allow_negative = $(this).is('[data-validation*="allow_negative"]');
	if ((keyCode > 31 && (keyCode < 48 || keyCode > 57) && (keyCode < 96 || keyCode > 105) && keyCode != 190 && keyCode != 110 && keyCode != 188 && keyCode != 189 && keyCode != 109 && ! (allow_negative && keyCode == 173)) && ! (controlDown && (keyCode == 67 || keyCode == 86)) && keyCode != 116 && (keyCode < 37 || keyCode > 40) && keyCode != 46) 
		return false;
	return true;
});
...
$('body').on('keydown', '[data-validation~="integer"]', function(e) {
	var keyCode = e.originalEvent.keyCode;
	var allow_negative = $(this).is('[data-validation*="allow_negative"]');
	if ((keyCode > 31 && (keyCode < 48 || keyCode > 57) && (keyCode < 96 || keyCode > 105) && keyCode != 110 && keyCode != 188 && ! (allow_negative && keyCode == 173)) && ! (controlDown && (keyCode == 67 || keyCode == 86)) && keyCode != 116 && (keyCode < 37 || keyCode > 40) && keyCode != 46) 
		return false;
	return true;
});
