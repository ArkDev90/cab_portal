...
<div class="panel panel-primary br-xs">
    ...
    <div class = "row">
        <div class = "col-md-12" style = "padding: 2% 0% 2% 0%; text-align:center">
			...
			<a href="<?=MODULE_URL?>edit/<?php echo $id ?>" class="btn btn-default">Cancel</a>
        </div>
    </div>
</div>
</form>
...
<script>
	...
	$('#username').on('input', function() {
		if (ajax_call != '') {
		    ...
		    ajax_call = $.post('<?=MODULE_URL?>ajax/ajax_check_user_uname', 'username=' + username + '<?=$ajax_post?>', function(data) {
