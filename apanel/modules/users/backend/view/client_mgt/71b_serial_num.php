<div class="panel panel-primary br-xs">
    ...
    <div class = "row report_name">
        FORM 71-B : Serial Number (<?php echo $month.' '.$year; ?>)
    </div>
    <div class = "row nav_link">
        <a href = "" data-toggle = "back_page">Back to FORM 71-B : Domestic Airfreight Forwarder Cargo Production Report</a>
    </div>
...
<script>
	...
	function getList() {
		...
		ajax_call = $.post('<?=MODULE_URL?>ajax/ajax_serialnum71b_list', ajax, function(data) {
	...
	$("#download").on('click', function() {
        window.open("<?php echo MODULE_URL ?>serialnum71b_pdf/<?php echo $client_id.'/'. $id ?>");
    });
</script>
