		...
		<table border = "1" id="list" class="table table-hover table-sidepad">
			...
			<?php
				...
				echo $ui->loadElement('table')
						...
						->addHeader(($db_table == 'form51a') ? 'Report Period' : 'Report Period', array('class' => 'col-md-2 header'),'sort','year, timespan')

						->addHeader('Submitted By', array('class' => 'col-md-2'))

						->addHeader('Submitted Date', array('class' => 'col-md-2 header'),'sort','submitteddate')
...
<script>
	...
	function getList() {
		...
		ajax_call = $.post('<?=MODULE_URL?>ajax/ajax_view_report_list', ajax, function(data) {
