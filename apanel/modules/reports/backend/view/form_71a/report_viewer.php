<div class="panel panel-primary br-xs">
    ...
    <div class = "row report_name">
        ...
        FORM 71-A : International Airfreight Forwarder Cargo Production Report (August 2017)

    </div>

    <div class = "row nav_link">

        <a href = "">Back to FORM 71-A : International Airfreight Forwarder Cargo Production Report List</a>
