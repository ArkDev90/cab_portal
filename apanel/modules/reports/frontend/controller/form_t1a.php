...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->formt1a_model		= new formt1a_model();
		...
		$this->report_form_table	= 'formt1a';

		$this->report_form_id		= '17';
	...
	public function listing() {
		...
		$this->view->load('formt1a/form_t1a_list', $data);
	...
	public function create($year = 0, $month = 0) {
		...
		$data['destination_list']	= $data['origin_list'];
		...
		$this->view->load('formt1a/form_t1a', $data);
	...
	public function edit($report_id) {
		...
		$report = $this->formt1a_model->getReport($this->header_fields, $report_id, $this->client_id, $this->user_id, $this->user_group);
		...
		$data['form_details']		= $this->formt1a_model->getReportDetails($this->detail_fields, $report_id);
	...
	public function delete($report_id) {
		...
		$this->view->load('formt1a/form_t1a_delete', $data);
	...
	public function view_draft_list() {
		...
		$this->view->load('formt1a/form_t1a_draft_list', $data);
	...
	private function ajax_list() {
		...
		foreach ($pagination->result as $key => $row) {
			...
			$row_url = BASE_URL ."client_users_mgt/users/report_viewer/".$this->client_id."/formt1a/".$row->id;
			$table .= '<tr>';
	...
	private function ajax_create() {
		...
		$result = $this->formt1a_model->saveReport($header, $details);



		if ($result && $status == 'Approved') {

			$report_id = $this->formt1a_model->getReportId();
	...
	private function ajax_edit() {
		...
		$result = $this->formt1a_model->updateReport($header, $details, $report_id, $this->client_id);
	...
	private function ajax_delete() {
		...
		$result = $this->formt1a_model->deleteReport($report_id, $this->client_id);
