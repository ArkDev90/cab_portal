...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->form61a_model		= new form61a_model();
		...
		$this->report_form_table	= 'form61a';

		$this->report_form_id		= '16';
	...
	public function listing() {
		...
		$this->view->load('form61a/form_61a_list', $data);
	...
	public function create($year = 0, $month = 0) {
		...
		$this->view->load('form61a/form_61a', $data);
	...
	public function edit($report_id) {
		...
		$report = $this->form61a_model->getReport($this->header_fields, $report_id, $this->client_id, $this->user_id, $this->user_group);
		...
		$data['form_details']	= $this->form61a_model->getReportDetails($this->detail_fields, $report_id);
	...
	public function delete($report_id) {
		...
		$this->view->load('form61a/form_61a_delete', $data);
	...
	public function view_draft_list() {
		...
		$this->view->load('form61a/form_61a_draft_list', $data);
	...
	private function ajax_list() {
		...
		foreach ($pagination->result as $key => $row) {
			...
			$row_url = BASE_URL ."client_users_mgt/users/report_viewer/".$this->client_id."/form61a/".$row->id;
			$table .= '<tr>';
	...
	private function ajax_create() {
		...
		$result = $this->form61a_model->saveReport($header, $details);



		if ($result && $status == 'Approved') {

			$report_id = $this->form61a_model->getReportId();
	...
	private function ajax_edit() {
		...
		$result = $this->form61a_model->updateReport($header, $details, $report_id, $this->client_id);



		if ($status == 'Approved' && in_array($this->user_group, array('User', 'GSA'))) {
	...
	private function ajax_delete() {
		...
		$result = $this->form61a_model->deleteReport($report_id, $this->client_id);
