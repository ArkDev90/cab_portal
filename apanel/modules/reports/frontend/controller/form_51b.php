...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->form51b_model		= new form51b_model();
		...
		$this->report_form_table	= 'form51b';

		$this->report_form_id		= '18';
		...
		$this->detail_fields2		= array(
			...
			't_routeFrom' => 'routeFrom',

			't_aircraft' => 'aircraft',

			't_cargoRev' => 'cargoRev',

			't_cargoNonRev' => 'cargoNonRev',

			't_mailRev' => 'mailRev',

			't_mailNonRev' => 'mailNonRev',

			't_cargoRevDep' => 'cargoRevDep',

			't_cargoNonRevDep' => 'cargoNonRevDep',

			't_mailRevDep' => 'mailRevDep',

			't_mailNonRevDep' => 'mailNonRevDep'
	...
	public function listing() {
		...
		$this->view->load('form51b/form_51b_list', $data);
	...
	public function create($year = 0, $month = 0) {
		...
		$this->view->load('form51b/form_51b', $data);
	...
	public function edit($report_id) {
		...
		$report = $this->form51b_model->getReport($this->header_fields, $report_id, $this->client_id, $this->user_id, $this->user_group);
		...
		$data['form_details']	= $this->form51b_model->getReportDetails($this->detail_fields, $report_id);

		$data['form_details2']	= $this->form51b_model->getReportDetails2($this->detail_fields2, $report_id);
	...
	public function delete($report_id) {
		...
		$this->view->load('form51b/form_51b_delete', $data);
	...
	public function view_draft_list() {
		...
		$this->view->load('form51b/form_51b_draft_list', $data);
	...
	private function ajax_list() {
		...
		foreach ($pagination->result as $key => $row) {
			...
			$row_url = BASE_URL ."client_users_mgt/users/report_viewer/".$this->client_id."/form51b/".$row->id;
			$table .= '<tr>';
	...
	private function ajax_create() {
		...
		$result = $this->form51b_model->saveReport($header, $details, $details2);



		if ($result && $status == 'Approved') {

			$report_id = $this->form51b_model->getReportId();
	...
	private function ajax_edit() {
		...
		$result = $this->form51b_model->updateReport($header, $details, $details2, $report_id, $this->client_id);
	...
	private function ajax_delete() {
		...
		$result = $this->form51b_model->deleteReport($report_id, $this->client_id);
