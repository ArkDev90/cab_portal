...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->form71c_model		= new form71c_model();
		...
		$this->report_form_table	= 'form71c';

		$this->report_form_id		= '8';
	...
	public function listing() {
		...
		$this->view->load('form71c/form_71c_list', $data);
	...
	public function create($year = 0, $month = 0) {
		...
		$this->view->load('form71c/form_71c', $data);
	...
	public function edit($report_id) {
		...
		$report = $this->form71c_model->getReport($this->header_fields, $report_id, $this->client_id, $this->user_id, $this->user_group);
		...
		$data['form_details']		= $this->form71c_model->getReportDetails($this->detail_fields, $report_id);
	...
	public function delete($report_id) {
		...
		$this->view->load('form71c/form_71c_delete', $data);
	...
	public function view_draft_list() {
		...
		$this->view->load('form71c/form_71c_draft_list', $data);
	...
	private function ajax_list() {
		...
		foreach ($pagination->result as $key => $row) {
			...
			$row_url = BASE_URL ."client_users_mgt/users/report_viewer/".$this->client_id."/form71c/".$row->id;
			$table .= '<tr>';
	...
	private function ajax_create() {
		...
		$result = $this->form71c_model->saveReport($header, $details);



		if ($result && $status == 'Approved') {

			$report_id = $this->form71c_model->getReportId();
	...
	private function ajax_edit() {
		...
		$result = $this->form71c_model->updateReport($header, $details, $report_id, $this->client_id);
	...
	private function ajax_delete() {
		...
		$result = $this->form71c_model->deleteReport($report_id, $this->client_id);
