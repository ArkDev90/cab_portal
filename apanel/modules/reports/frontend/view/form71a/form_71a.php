					...
					<table id="tableList4" class="table table-bordered table-sidepad mb-none">
						...
						<thead>
							...
							<tr class="info">
								...
								<th colspan="2">HOUSER/SERIAL NUMBER</th>
...
<script>
	...
	function checkButtons() {
		...
		$('#submit_report').attr('disabled', ! ((has_entry || no_operation) && (has_entry2 || no_operation2) && (has_entry3 || no_operation3) && ($('#tableList2 tbody .entry').length == 0 || $('#serial_number #serialnum').val() != '') && $('#tableList4 #included_error').html() == '' && $('#tableList4 #excluded_error').html() == ''));
		...
		if ($('#tableList2 tbody .entry').length > 0) {
