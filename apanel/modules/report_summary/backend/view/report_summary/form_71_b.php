<form action="" method="post" id = "form71b">
...
<script>
    $("#pdf").on('click', function() {
        window.open('<?php echo MODULE_URL ?>form_71b_pdf?' + $('#form71b').serialize());
    });
    $("#csv").on('click', function() {
        window.open('<?php echo MODULE_URL ?>form_71b_csv?' + $('#form71b').serialize());
    });
</script>