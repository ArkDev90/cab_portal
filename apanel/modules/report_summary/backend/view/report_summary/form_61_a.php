<form action="" method="post" id = "form61a">
<div class="panel panel-primary br-xs" id="filters">
    ...
    </div> <div class="panel panel-primary br-xs col-md-11" style = "margin: 0% 1% 2% 4%; padding: 1%">
...
<script>
    ...
    $("#pdf").on('click', function() {
        window.open('<?php echo MODULE_URL ?>print_form61a_pdf?' + $('#form61a').serialize());
    });
    $("#csv").on('click', function() {
        window.open('<?php echo MODULE_URL ?>form_61a_csv?' + $('#form61a').serialize());
    });
</script>