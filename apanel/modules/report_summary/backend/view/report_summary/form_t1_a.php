<form action="" method="post" id = "formt1a">
<div class="panel panel-primary br-xs" id="filters">
	<div class="panel-heading bb-colored text-center">
		FORM T-1A : Domestic Sector Load Report
	</div>
    <div class = "row">
	<div class="panel panel-primary br-xs col-md-8" style = "margin: 2% 0% 2% 3%; padding: 2%">
        ...
        <div class = "row" style = "padding:2% 0% 0% 0%">
            <div class = "col-md-3 filter_col">
                <input type = "radio" name = "category" value = "bySector" checked = "checked"> by Sector
                <div class = "col-md-12" style = "padding: 2% 0% 0% 5%">
                    <input type = "checkbox" name = "s_passenger" value = "Passenger"> Passenger <br>
                    <input type = "checkbox" name = "s_seats" value = "Seats"> Seats <br>
                    <input type = "checkbox" name = "s_cargo" value = "Cargo"> Cargo 
                </div>
            </div>
            <div class = "col-md-4 filter_col">
                <input type = "radio" name = "category" value = "byAirline"> by Airline
                <div class = "col-md-12" style = "padding: 2% 0% 0% 5%">
                    <input type = "checkbox" name = "a_load_factor" value = "LoadFactor"> Load Factor <br>
                    <input type = "checkbox" name = "a_market_share" value = "MarketShare"> Market Share 
                </div>
            </div>
            <div class = "col-md-5 filter_col">
                <input type = "radio" name = "category" value = "AirlineSummary"> Summary per Airline
                <div class = "col-md-12" style = "padding: 2% 0% 0% 5%">
                    <?php
                        echo $ui->formField('dropdown')
                        ->setName('airline')
    ...
    <div class="panel panel-primary br-xs col-md-3" style = "margin: 2% 2% 2% 2%; padding: 3%">
        ...
        <div class = "row filter_col" style = "padding:2% 0% 0% 0%">
            <div class = "col-md-12">
                ...
                <div class = "col-md-12" style = "padding: 2% 0% 0% 5%">
                    <input type = "checkbox" name = "h_passenger" value = "Passenger"> Passenger <br>
                    <input type = "checkbox" name = "h_cargo" value = "Cargo"> Cargo
                    <div class = "col-md-12" style = "padding: 5% 0% 0% 10%">
                        <input type = "checkbox" name = "h_load_factor" value = "LoadFactor"> Load Factor <br>
                        <input type = "checkbox" name = "h_market_share" value = "MarketShare"> Market Share
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $("#pdf").on('click', function() {
        window.open('<?php echo MODULE_URL ?>form_t1a_pdf?' + $('#formt1a').serialize());
    });
    $("#csv").on('click', function() {
        window.open('<?php echo MODULE_URL ?>form_t1a_csv?' + $('#formt1a').serialize());
    });
</script>